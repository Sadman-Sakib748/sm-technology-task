      ...
      <section className="relative px-4 py-12 lg:py-20 z-10 min-h-screen flex flex-col justify-center w-full">
        <div className="flex flex-col-reverse md:flex-row items-center md:gap-12 lg:gap-12 relative h-full w-full">
          ...
          <div className="absolute top-0 left-0 -ml-4 w-12 h-12 md:w-16 md:h-16">
            <Image src={tree} alt="Leaf" fill className="object-contain" />
          </div>
          ...
          <div className="flex-1 ml-13 space-y-6 md:space-y-8 lg:space-y-8 order-2 md:order-1 h-full flex flex-col justify-center relative">
            ...
            <p className="text-sm md:text-base lg:text-base text-gray-600 max-w-md">
              ...
              finest and most nutritious fresh fruits and vegetables.
            </p>
            ...
            <div className="grid grid-cols-2 gap-1">
              ...
              <div
                className="w-[172px] md:w-[300px] lg:w-[240px] h-[110px] 
              ...
              >
                ...
                <div className="flex flex-col justify-center space-y-1.5">
                  ...
                  <p className="text-[9px] md:text-base font-semibold text-gray-900">
                    Fresh Salad
                  </p>
            ...
            <div className="relative w-40 sm:w-48">
              {/* Download Label */}
              <p className="text-black font-semibold mt-12 relative z-10">
                Download App :
              </p>
              ...
              <div className="flex items-center mt-9 gap-2 relative z-10">
                ...
                >
                  ...
                  >
                    <path
                      d="M3.6 2.4c-.37.22-.6.63-.6 1.07v17.06c0 .44.23.85.6 1.07l9.38-9.6L3.6 2.4z"
                      fill="currentColor"
                    />
                    <path
                      d="M14.06 12.97 18.7 17c.57.44 1.38.03 1.38-.68V7.69c0-.71-.81-1.12-1.38-.68l-4.64 4.03a.9.9 0 0 0 0 1.39z"
                      fill="currentColor"
                    />
                    <path
                      d="M3.6 21.6c.26.16.6.18.9-.03l9.04-5.62-2.56-2.62L3.6 21.6z"
                      fill="currentColor"
                    />
                    <path
                      d="M4.5 2.43c-.3-.2-.64-.19-.9-.03l7.38 8 2.56-2.62L4.5 2.43z"
                      fill="currentColor"
                    />
                  </svg>
                  <span className="leading-none text-left">
